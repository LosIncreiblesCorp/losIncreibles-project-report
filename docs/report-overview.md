...
- [CAPÍTULO IV: PRODUCT DESIGN](chapter4.md#capítulo-iv-product-design)
  ...
  - [4.6. Domain-Driven Software Architecture](chapter4.md#46-domain-driven-software-architecture)
    ...
    - [4.6.3. Software Architecture Container Diagrams](chapter4.md#463-software-architecture-container-diagrams)
    - [4.6.4. Software Architecture Components Diagrams](chapter4.md#464-software-architecture-components-diagrams)
